...
class ToServer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:test.ToServer) */ {
 public:
  ...
  inline ToServer* New() const { return New(NULL); }

  ToServer* New(::google::protobuf::Arena* arena) const;
 ...
 private:
  ...
  inline void set_has_modeinfo();
  inline void clear_has_modeinfo();
  ...
  bool forward_;
  bool backward_;
  friend void  protobuf_AddDesc_test_5fToServer_2eproto();
  friend void protobuf_AssignDesc_test_5fToServer_2eproto();
  friend void protobuf_ShutdownFile_test_5fToServer_2eproto();

  void InitAsDefaultInstance();
  static ToServer* default_instance_;
};
// ===================================================================
